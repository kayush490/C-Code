/*
	Program:	Report Card Generating App
	Author: 	Ayush Kumar
*/
...
int main() {
    ...
    if (totalScore > 500 || totalScore < 0) {
    	puts("Total score cannot not be greater than 500 or less than 0. Please try again!");
